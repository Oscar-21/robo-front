      ...
      <div>
        ...
        <main>
          ...
          <div style={grid}>
            ...
            <Tabs index={-1}>
              <Tab style={tabChildNewTextz} label="Tournament" />

              <Tab style={tabChildNewText} label="home" containerElement={<Link to="/"></Link>} />

              <Tab style={tabChildNewText} label="about" containerElement={<Link to="/About"></Link>} />

              <Tab style={tabChildNewText} label="kits" containerElement={<Link to="/Browse"></Link>} />

              <Tab style={tabChildNewText} label="The Arena" containerElement={<Link to="/Dashboard"></Link>} />

              <Tab style={tabChildNewText} label="the cloud" />

              <Tab style={tabChildNewTextz} label="news" containerElement={<Link to="/SignIn"></Link>} />

              <Tab style={tabChildNewTextz} label="Contact" containerElement={<Link to="/SignUp"></Link>} />
            </Tabs>
